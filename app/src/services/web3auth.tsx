  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        ...
        const clientId = process.env.REACT_APP_CLIENT_ID || "BAfxRrhtHkvXQZSsKywXy6PHIfp3DAbpnIFSb6B6rdSRYuFLegQ5gjVGHpoPjS5m3wMxEgAH6vqFKNoWzXC3PSc";
        const verifier = process.env.REACT_APP_VERIFIER || "aloalo2";
